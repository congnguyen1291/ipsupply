...
class ImageIco {
	 ...
	 *
	 * If the constructor is not passed a file, a file will need to be supplied using the {@link ImageIco::add_image}
	...
	function __construct( $file = false, $sizes = array() ) {
		...
		foreach ( $required_functions as $function ) {
			if ( ! function_exists( $function ) ) {
				trigger_error( "The ImageIco class was unable to find the $function function, which is part of the GD library. Ensure that the system has the GD library installed and that PHP has access to it through a PHP interface, such as PHP's GD module. Since this function was not found, the library will be unable to create ICO files." );
				return;
			}
		}
