...
namespace Assetic\Symfony\Process\Tests;

use PHPUnit\Framework\TestCase;
use Assetic\Symfony\Process\Exception\LogicException;
use Assetic\Symfony\Process\Exception\ProcessTimedOutException;
use Assetic\Symfony\Process\Exception\RuntimeException;
use Assetic\Symfony\Process\InputStream;
use Assetic\Symfony\Process\PhpExecutableFinder;
use Assetic\Symfony\Process\Pipes\PipesInterface;
use Assetic\Symfony\Process\Process;
...
class ProcessTest extends TestCase
{
    ...
    /**
     * @expectedException \Assetic\Symfony\Process\Exception\InvalidArgumentException
     */
    ...
    /**
     * @expectedException \Assetic\Symfony\Process\Exception\LogicException
     ...
     * @expectedException \Assetic\Symfony\Process\Exception\InvalidArgumentException
     * @expectedExceptionMessage Assetic\Symfony\Process\Process::setInput only accepts strings, Traversable objects or stream resources.
     */
    ...
    /**
     * @expectedException \Assetic\Symfony\Process\Exception\RuntimeException
    ...
    /**
     * @expectedException \Assetic\Symfony\Process\Exception\ProcessFailedException
     */
    ...
    /**
     * @expectedException \Assetic\Symfony\Process\Exception\ProcessTimedOutException
    ...
    public function testMethodsThatNeedARunningProcess($method)
    {
        ...
        if (method_exists($this, 'expectException')) {
            $this->expectException('Assetic\Symfony\Process\Exception\LogicException');
            $this->expectExceptionMessage(sprintf('Process must be started before calling %s.', $method));
        } else {
            $this->setExpectedException('Assetic\Symfony\Process\Exception\LogicException', sprintf('Process must be started before calling %s.', $method));
        }
    ...
    private function skipIfNotEnhancedSigchild($expectException = true)
    {
        if (self::$sigchild) {
            if (!$expectException) {
                ...
                if (method_exists($this, 'expectException')) {
                    $this->expectException('Assetic\Symfony\Process\Exception\RuntimeException');
                    $this->expectExceptionMessage('This PHP has been compiled with --enable-sigchild.');
                } else {
                    $this->setExpectedException('Assetic\Symfony\Process\Exception\RuntimeException', 'This PHP has been compiled with --enable-sigchild.');
                }
            }
        }
    }
