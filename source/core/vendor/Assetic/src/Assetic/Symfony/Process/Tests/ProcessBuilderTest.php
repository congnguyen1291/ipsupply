...
use Assetic\Symfony\Process\ProcessBuilder;
...
class ProcessBuilderTest extends TestCase
{
    ...
    /**
     * @expectedException \Assetic\Symfony\Process\Exception\InvalidArgumentException
     * @expectedExceptionMessage Assetic\Symfony\Process\ProcessBuilder::setInput only accepts strings, Traversable objects or stream resources.
     */
