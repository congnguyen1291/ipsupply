...
class WebsitesTable extends AppTable {
    ...
    public function getWebsite($domain){
        ...
        if(!$results){
            ...
            $select->join('websites_app_facebook', 'websites.website_id=websites_app_facebook.website_id',array('default_access_token','long_access_token', 'date_access_token'), 'left');
    ...
    public function updateAccessTokenFacebook( $default_access_token, $long_access_token = '' ){
        if( !empty($users_id) && !empty($app_facebook_id)
            && !empty($default_access_token) ){
            $adapter = $this->tableGateway->getAdapter();
            $sql = new Sql($adapter);
            ...
            $insert->columns(array('website_id', 'default_access_token','long_access_token','date_access_token'));
            $insert->values(array(
                'website_id' => $_SESSION['website_id'],
