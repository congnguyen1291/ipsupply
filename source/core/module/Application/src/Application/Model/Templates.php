...
class Templates implements InputFilterAwareInterface{
    ...
    public function exchangeArray($data)
    {
        ...
        $this->template_alias  = (isset($data['template_alias'])) ? $data['template_alias'] : '';
        $this->template_description  = (isset($data['template_description'])) ? $data['template_description'] : '';
        $this->template_thumb  = (isset($data['template_thumb'])) ? $data['template_thumb'] : '';
        $this->template_thumb_mobile  = (isset($data['template_thumb_mobile'])) ? $data['template_thumb_mobile'] : '';
