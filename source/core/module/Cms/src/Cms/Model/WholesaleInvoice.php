...
class WholesaleInvoice  implements InputFilterAwareInterface{
    ...
    {
        $this->invoice_id = (!empty($data['wholesale_id'])) ? $data['wholesale_id'] : NULL;
        ...
        $this->invoice_title = (!empty($data['wholesale_title'])) ? $data['wholesale_title'] : ('HD'.time());
        $this->invoice_description = (!empty($data['wholesale_description'])) ? $data['wholesale_description'] : '';
