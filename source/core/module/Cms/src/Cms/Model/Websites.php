...
class Websites extends MultiLevel  implements InputFilterAwareInterface {
    ...
    public function exchangeArray($data)
    {
        ...
        $this->google_client_id  = (isset($data['facebook_id'])) ? $data['google_client_id'] : '';
        $this->ship  = (isset($data['ship'])) ? $data['ship'] : 0;
        $this->type_buy  = (isset($data['type_buy'])) ? $data['type_buy'] : 0;
        ...
        $this->is_demo  = (isset($data['is_demo'])) ? $data['is_demo'] : 0;
