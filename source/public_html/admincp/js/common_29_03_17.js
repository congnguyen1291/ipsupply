...
tmlFacebook = {
    ...
    user : {
        ...
        getPicture : function( use ){
            if( typeof use != 'undefined'
                ...
                && typeof use.picture.url != 'undefined'
    ...
    feed : {
        hasPermissionComment : function( fee ){
            if( typeof fee != 'undefined'
                && typeof fee.summary_comment != 'undefined'
                && typeof fee.summary_comment.can_comment != 'undefined'
                && (fee.summary_comment.can_comment == 'true' || fee.summary_comment.can_comment == true ) ){
                return true;
            }
            return false;
        },
        hasPermissionLike : function( fee ){
            if( typeof fee != 'undefined'
                && typeof fee.summary_likes != 'undefined'
                && typeof fee.summary_likes.can_like != 'undefined'
                && (fee.summary_likes.can_like == 'true' || fee.summary_likes.can_like == true ) ){
                return true;
            }
            return false;
        },
    ...
    comment : {
        isReaded : function( cm ){
            if( typeof cm != 'undefined'
                ...
                && cm.id.length > 0
                && tmlFacebook.model.comments.data != 'undefined'
                && tmlFacebook.model.comments.data.readed != 'undefined' ){
                if( tmlFacebook.model.comments.data.readed.indexOf( cm.id ) > -1 ){
                    return true;
                }
            }
            return false;
        ...
        isImportant : function( cm ){
            if( typeof cm != 'undefined'
                ...
                && cm.id.length > 0
                && tmlFacebook.model.comments.data != 'undefined'
                && tmlFacebook.model.comments.data.important != 'undefined' ){
                if( tmlFacebook.model.comments.data.important.indexOf( cm.id ) > -1 ){
                    return true;
                }
            }
            return false;
        ...
        hasPermissionComment : function( cm ){
            if( typeof cm != 'undefined'
                && typeof cm.summary_comment != 'undefined'
                && typeof cm.summary_comment.can_comment != 'undefined'
                && (cm.summary_comment.can_comment == 'true' || cm.summary_comment.can_comment == true ) ){
                return true;
            }
            return false;
        },
        hasPermissionLike : function( cm ){
            if( typeof cm != 'undefined'
                && typeof cm.summary_likes != 'undefined'
                && typeof cm.summary_likes.can_like != 'undefined'
                && (cm.summary_likes.can_like == 'true' || cm.summary_likes.can_like == true ) ){
                return true;
            }
            return false;
        },
        ...
        getCreatedTime : function( cm ){
            if( typeof cm != 'undefined'
                && typeof cm.created_time != 'undefined'
                && typeof cm.created_time.date != 'undefined'
                && cm.created_time.date.length > 0 ){
                return cm.created_time.date;
            }
            return '';
        },
        getShortCreatedTime : function( cm ){
            if( typeof cm != 'undefined'
                ...
                && typeof cm.created_time.date != 'undefined'
                && cm.created_time.date.length > 0 ){
                var date = new Date(cm.created_time.date);
                var monthNames = [
                    ...
                    if( typeof data != 'undefined'
                        ...
                        try{
                            if( data.result.is_readed == 1 ){
                                if( typeof tmlFacebook.model.comments.data.readed == 'undefined'
                                    || tmlFacebook.model.comments.data.readed.length <=0 ){
                                    tmlFacebook.model.comments.data.readed = [];
                                }
                                tmlFacebook.model.comments.data.readed.push(data.id);
                            }else{
                                var i = tmlFacebook.model.comments.data.readed.indexOf(data.id);
                                if(i != -1) {
                                    tmlFacebook.model.comments.data.readed.splice(i, 1);
                                }
                            }
                        }catch(e){}
                        tmlFacebook.updateView();
                    ...
                    if( typeof data != 'undefined'
                        ...
                        try{
                            if( data.result.is_important == 1 ){
                                if( typeof tmlFacebook.model.comments.data.important == 'undefined'
                                    || tmlFacebook.model.comments.data.important.length <=0 ){
                                    tmlFacebook.model.comments.data.important = [];
                                }
                                tmlFacebook.model.comments.data.important.push(data.id);
                            }else{
                                var i = tmlFacebook.model.comments.data.important.indexOf(data.id);
                                if(i != -1) {
                                    tmlFacebook.model.comments.data.important.splice(i, 1);
                                }
                            }
                        }catch(e){}
                        tmlFacebook.updateView();
        ...
        $('[data-btn="moreComments"]', "#COZFBContainer").off('click').on('click', function(e){
            ...
            tmlFacebook.getComments( function( cm ){
                ...
                if( typeof tmlFacebook.model.comments.data != 'undefined'
                    ...
                    tmlFacebook.model.comments.data.error = cm.error;
                    tmlFacebook.model.comments.data.offset = cm.offset;
                    tmlFacebook.model.comments.data.xoffset = cm.xoffset;
                    tmlFacebook.model.comments.data.until = cm.until;
            ...
            if( tmlFacebook.isLoadingFeed(tmlFacebook.model.feeds) ){
                tmlFacebook.getFeeds( function( fe ){
                    ...
                    if( typeof tmlFacebook.model.feeds.data != 'undefined'
                        ...
                        tmlFacebook.model.feeds.data.error = fe.error;
                        tmlFacebook.model.feeds.data.offset = fe.offset;
                        tmlFacebook.model.feeds.data.until = fe.until;
    ...
    getComments : function( callback ){
        if( typeof tmlFacebook.model.comments.data == 'undefined'
            ...
            if( !tmlFacebook.isLoadingComment(tmlFacebook.model.comments) ){
                if( typeof tmlFacebook.model.comments.data != 'undefined'
                    && typeof tmlFacebook.model.comments.data.offset != 'undefined' ){
                    offset = tmlFacebook.model.comments.data.offset;
                }
                if( typeof tmlFacebook.model.comments.data != 'undefined'
                    && typeof tmlFacebook.model.comments.data.xoffset != 'undefined' ){
                    xoffset = tmlFacebook.model.comments.data.xoffset;
                }
                if( typeof tmlFacebook.model.comments.data != 'undefined'
                    && typeof tmlFacebook.model.comments.data.until != 'undefined' ){
                    until = tmlFacebook.model.comments.data.until;
                }
            }
            $.ajax({
                type:'POST',
                url : tmlFacebook.getCommentUrl,
                dataType: 'json',
                data: {offset:offset, xoffset:xoffset, until:until},
                success: function(data){
                    if(data.constructor === String){
                        data = JSON.parse(data);
                    }
    ...
    getFeeds : function( callback ){
        if( typeof tmlFacebook.model.feeds.data == 'undefined'
            ...
            if( !tmlFacebook.isLoadingFeed(tmlFacebook.model.feeds) ){
                if( typeof tmlFacebook.model.feeds.data != 'undefined'
                    && typeof tmlFacebook.model.feeds.data.offset != 'undefined' ){
                    offset = tmlFacebook.model.feeds.data.offset;
                }
                if( typeof tmlFacebook.model.feeds.data != 'undefined'
                    && typeof tmlFacebook.model.feeds.data.until != 'undefined' ){
                    until = tmlFacebook.model.feeds.data.until;
                }
            }
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: {offset:offset, until:until},
                success: function(data){
                    if(data.constructor === String){
                        data = JSON.parse(data);
                    }
